//
//  MessageOutOfCredits2.swift
//  PaintingsAndArtists
//
//  Created by Normand Martin on 2021-04-14.
//  Copyright © 2021 Normand Martin. All rights reserved.
//

import UIKit
class MessageOutOfCredits2{
    class func showMessageView(view: UIView, messageView: UIView,  messageLabel: UILabel, okBuyCreditsButton: RoundButton){
    ...
    class func dismissMessageview(messageView: UIView) {
